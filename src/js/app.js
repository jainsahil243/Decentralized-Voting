    ...
    VotingContract.deployed().then(function(instance){
      ...
      instance.getNumOfCandidates().then(function(numOfCandidates){
        ...
        if (numOfCandidates == 0){
          ...
          instance.addCandidate("Rahul Gandhi","Congress").then(function(result){ 
            $("#candidate-box").append(`<div class='form-check'><input class='form-check-input' type='checkbox' value='' id=${result.logs[0].args.candidateID}><label class='form-check-label' for=0>Rahul Gandhi</label></div>`)
          })
          instance.addCandidate("Narendra Modi","BJP").then(function(result){
            $("#candidate-box").append(`<div class='form-check'><input class='form-check-input' type='checkbox' value='' id=${result.logs[0].args.candidateID}><label class='form-check-label' for=1>Narendra Modi</label></div>`)
          })
